...
public class GroupsCreateNewGroupRequestGroup {
  ...
  private List<Integer> mutedCategoryIds = null;
  ...
  private List<Integer> regularCategoryIds = null;
  ...
  private List<Integer> watchingCategoryIds = null;
  ...
  private List<Integer> trackingCategoryIds = null;
  ...
  private List<Integer> watchingFirstPostCategoryIds = null;

  public GroupsCreateNewGroupRequestGroup() {
  }

  public GroupsCreateNewGroupRequestGroup name(String name) {
  ...
  **/
  ...
  public GroupsCreateNewGroupRequestGroup fullName(String fullName) {
  ...
  **/
  ...
  public GroupsCreateNewGroupRequestGroup bioRaw(String bioRaw) {
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(value = "About Group")
  ...
  public GroupsCreateNewGroupRequestGroup usernames(String usernames) {
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(value = "comma,separated")
  ...
  public GroupsCreateNewGroupRequestGroup ownerUsernames(String ownerUsernames) {
  ...
  **/
  ...
  public GroupsCreateNewGroupRequestGroup automaticMembershipEmailDomains(String automaticMembershipEmailDomains) {
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(value = "pipe|separated")
  ...
  public GroupsCreateNewGroupRequestGroup visibilityLevel(Integer visibilityLevel) {
  ...
  **/
  ...
  public GroupsCreateNewGroupRequestGroup primaryGroup(Boolean primaryGroup) {
  ...
  **/
  ...
  public GroupsCreateNewGroupRequestGroup flairIcon(String flairIcon) {
  ...
  **/
  ...
  public GroupsCreateNewGroupRequestGroup flairUploadId(Integer flairUploadId) {
  ...
  **/
  ...
  public GroupsCreateNewGroupRequestGroup flairBgColor(String flairBgColor) {
  ...
  **/
  ...
  public GroupsCreateNewGroupRequestGroup publicAdmission(Boolean publicAdmission) {
  ...
  **/
  ...
  public GroupsCreateNewGroupRequestGroup publicExit(Boolean publicExit) {
  ...
  **/
  ...
  public GroupsCreateNewGroupRequestGroup defaultNotificationLevel(Integer defaultNotificationLevel) {
  ...
  **/
  ...
  public GroupsCreateNewGroupRequestGroup mutedCategoryIds(List<Integer> mutedCategoryIds) {
  ...
  public GroupsCreateNewGroupRequestGroup addMutedCategoryIdsItem(Integer mutedCategoryIdsItem) {
  ...
  **/
  ...
  public GroupsCreateNewGroupRequestGroup regularCategoryIds(List<Integer> regularCategoryIds) {
  ...
  public GroupsCreateNewGroupRequestGroup addRegularCategoryIdsItem(Integer regularCategoryIdsItem) {
  ...
  **/
  ...
  public GroupsCreateNewGroupRequestGroup watchingCategoryIds(List<Integer> watchingCategoryIds) {
  ...
  public GroupsCreateNewGroupRequestGroup addWatchingCategoryIdsItem(Integer watchingCategoryIdsItem) {
  ...
  **/
  ...
  public GroupsCreateNewGroupRequestGroup trackingCategoryIds(List<Integer> trackingCategoryIds) {
  ...
  public GroupsCreateNewGroupRequestGroup addTrackingCategoryIdsItem(Integer trackingCategoryIdsItem) {
  ...
  **/
  ...
  public GroupsCreateNewGroupRequestGroup watchingFirstPostCategoryIds(List<Integer> watchingFirstPostCategoryIds) {
  ...
  public GroupsCreateNewGroupRequestGroup addWatchingFirstPostCategoryIdsItem(Integer watchingFirstPostCategoryIdsItem) {
  ...
  **/
   ...
   * @return the GroupsCreateNewGroupRequestGroup instance itself
   */
  public GroupsCreateNewGroupRequestGroup putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    GroupsCreateNewGroupRequestGroup groupsCreateNewGroupRequestGroup = (GroupsCreateNewGroupRequestGroup) o;
    return Objects.equals(this.name, groupsCreateNewGroupRequestGroup.name) &&
        Objects.equals(this.fullName, groupsCreateNewGroupRequestGroup.fullName) &&
        Objects.equals(this.bioRaw, groupsCreateNewGroupRequestGroup.bioRaw) &&
        Objects.equals(this.usernames, groupsCreateNewGroupRequestGroup.usernames) &&
        Objects.equals(this.ownerUsernames, groupsCreateNewGroupRequestGroup.ownerUsernames) &&
        Objects.equals(this.automaticMembershipEmailDomains, groupsCreateNewGroupRequestGroup.automaticMembershipEmailDomains) &&
        Objects.equals(this.visibilityLevel, groupsCreateNewGroupRequestGroup.visibilityLevel) &&
        Objects.equals(this.primaryGroup, groupsCreateNewGroupRequestGroup.primaryGroup) &&
        Objects.equals(this.flairIcon, groupsCreateNewGroupRequestGroup.flairIcon) &&
        Objects.equals(this.flairUploadId, groupsCreateNewGroupRequestGroup.flairUploadId) &&
        Objects.equals(this.flairBgColor, groupsCreateNewGroupRequestGroup.flairBgColor) &&
        Objects.equals(this.publicAdmission, groupsCreateNewGroupRequestGroup.publicAdmission) &&
        Objects.equals(this.publicExit, groupsCreateNewGroupRequestGroup.publicExit) &&
        Objects.equals(this.defaultNotificationLevel, groupsCreateNewGroupRequestGroup.defaultNotificationLevel) &&
        Objects.equals(this.mutedCategoryIds, groupsCreateNewGroupRequestGroup.mutedCategoryIds) &&
        Objects.equals(this.regularCategoryIds, groupsCreateNewGroupRequestGroup.regularCategoryIds) &&
        Objects.equals(this.watchingCategoryIds, groupsCreateNewGroupRequestGroup.watchingCategoryIds) &&
        Objects.equals(this.trackingCategoryIds, groupsCreateNewGroupRequestGroup.trackingCategoryIds) &&
        Objects.equals(this.watchingFirstPostCategoryIds, groupsCreateNewGroupRequestGroup.watchingFirstPostCategoryIds)&&
        Objects.equals(this.additionalProperties, groupsCreateNewGroupRequestGroup.additionalProperties);
  }

  @Override
  public int hashCode() {
    return Objects.hash(name, fullName, bioRaw, usernames, ownerUsernames, automaticMembershipEmailDomains, visibilityLevel, primaryGroup, flairIcon, flairUploadId, flairBgColor, publicAdmission, publicExit, defaultNotificationLevel, mutedCategoryIds, regularCategoryIds, watchingCategoryIds, trackingCategoryIds, watchingFirstPostCategoryIds, additionalProperties);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class GroupsCreateNewGroupRequestGroup {\n");
  ...
  * @throws IOException if the JSON Object is invalid with respect to GroupsCreateNewGroupRequestGroup
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!GroupsCreateNewGroupRequestGroup.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in GroupsCreateNewGroupRequestGroup is not found in the empty JSON string", GroupsCreateNewGroupRequestGroup.openapiRequiredFields.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : GroupsCreateNewGroupRequestGroup.openapiRequiredFields) {
      ...
      if (jsonObj.get("muted_category_ids") != null && !jsonObj.get("muted_category_ids").isJsonArray()) {
      ...
      // ensure the optional json data is an array if present
      if (jsonObj.get("regular_category_ids") != null && !jsonObj.get("regular_category_ids").isJsonArray()) {
      ...
      // ensure the optional json data is an array if present
      if (jsonObj.get("watching_category_ids") != null && !jsonObj.get("watching_category_ids").isJsonArray()) {
      ...
      // ensure the optional json data is an array if present
      if (jsonObj.get("tracking_category_ids") != null && !jsonObj.get("tracking_category_ids").isJsonArray()) {
      ...
      // ensure the optional json data is an array if present
      if (jsonObj.get("watching_first_post_category_ids") != null && !jsonObj.get("watching_first_post_category_ids").isJsonArray()) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!GroupsCreateNewGroupRequestGroup.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'GroupsCreateNewGroupRequestGroup' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<GroupsCreateNewGroupRequestGroup> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(GroupsCreateNewGroupRequestGroup.class));

       return (TypeAdapter<T>) new TypeAdapter<GroupsCreateNewGroupRequestGroup>() {
           @Override
           public void write(JsonWriter out, GroupsCreateNewGroupRequestGroup value) throws IOException {
           ...
           @Override
           public GroupsCreateNewGroupRequestGroup read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             GroupsCreateNewGroupRequestGroup instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of GroupsCreateNewGroupRequestGroup given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of GroupsCreateNewGroupRequestGroup
  * @throws IOException if the JSON string is invalid with respect to GroupsCreateNewGroupRequestGroup
  */
  public static GroupsCreateNewGroupRequestGroup fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, GroupsCreateNewGroupRequestGroup.class);
  }

 /**
  * Convert an instance of GroupsCreateNewGroupRequestGroup to an JSON string
  *
  * @return JSON string
  */
