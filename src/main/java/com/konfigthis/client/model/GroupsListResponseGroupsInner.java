...
public class GroupsListResponseGroupsInner {
  ...
  public GroupsListResponseGroupsInner() {
  }

  public GroupsListResponseGroupsInner title(Object title) {
  ...
  **/
  ...
  public GroupsListResponseGroupsInner id(Integer id) {
  ...
  **/
  ...
  public GroupsListResponseGroupsInner automatic(Boolean automatic) {
  ...
  **/
  ...
  public GroupsListResponseGroupsInner name(String name) {
  ...
  **/
  ...
  public GroupsListResponseGroupsInner displayName(String displayName) {
  ...
  **/
  ...
  public GroupsListResponseGroupsInner userCount(Integer userCount) {
  ...
  **/
  ...
  public GroupsListResponseGroupsInner mentionableLevel(Integer mentionableLevel) {
  ...
  **/
  ...
  public GroupsListResponseGroupsInner messageableLevel(Integer messageableLevel) {
  ...
  **/
  ...
  public GroupsListResponseGroupsInner visibilityLevel(Integer visibilityLevel) {
  ...
  **/
  ...
  public GroupsListResponseGroupsInner primaryGroup(Boolean primaryGroup) {
  ...
  **/
  ...
  public GroupsListResponseGroupsInner grantTrustLevel(Object grantTrustLevel) {
  ...
  **/
  ...
  public GroupsListResponseGroupsInner incomingEmail(Object incomingEmail) {
  ...
  **/
  ...
  public GroupsListResponseGroupsInner hasMessages(Boolean hasMessages) {
  ...
  **/
  ...
  public GroupsListResponseGroupsInner flairUrl(Object flairUrl) {
  ...
  **/
  ...
  public GroupsListResponseGroupsInner flairBgColor(Object flairBgColor) {
  ...
  **/
  ...
  public GroupsListResponseGroupsInner flairColor(Object flairColor) {
  ...
  **/
  ...
  public GroupsListResponseGroupsInner bioRaw(Object bioRaw) {
  ...
  **/
  ...
  public GroupsListResponseGroupsInner bioCooked(Object bioCooked) {
  ...
  **/
  ...
  public GroupsListResponseGroupsInner bioExcerpt(Object bioExcerpt) {
  ...
  **/
  ...
  public GroupsListResponseGroupsInner publicAdmission(Boolean publicAdmission) {
  ...
  **/
  ...
  public GroupsListResponseGroupsInner publicExit(Boolean publicExit) {
  ...
  **/
  ...
  public GroupsListResponseGroupsInner allowMembershipRequests(Boolean allowMembershipRequests) {
  ...
  **/
  ...
  public GroupsListResponseGroupsInner fullName(Object fullName) {
  ...
  **/
  ...
  public GroupsListResponseGroupsInner defaultNotificationLevel(Integer defaultNotificationLevel) {
  ...
  **/
  ...
  public GroupsListResponseGroupsInner membershipRequestTemplate(Object membershipRequestTemplate) {
  ...
  **/
  ...
  public GroupsListResponseGroupsInner isGroupUser(Boolean isGroupUser) {
  ...
  **/
  ...
  public GroupsListResponseGroupsInner isGroupOwner(Boolean isGroupOwner) {
  ...
  **/
  ...
  public GroupsListResponseGroupsInner membersVisibilityLevel(Integer membersVisibilityLevel) {
  ...
  **/
  ...
  public GroupsListResponseGroupsInner canSeeMembers(Boolean canSeeMembers) {
  ...
  **/
  ...
  public GroupsListResponseGroupsInner canAdminGroup(Boolean canAdminGroup) {
  ...
  **/
  ...
  public GroupsListResponseGroupsInner canEditGroup(Boolean canEditGroup) {
  ...
  **/
  ...
  public GroupsListResponseGroupsInner publishReadState(Boolean publishReadState) {
  ...
  **/
   ...
   * @return the GroupsListResponseGroupsInner instance itself
   */
  public GroupsListResponseGroupsInner putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    GroupsListResponseGroupsInner groupsListResponseGroupsInner = (GroupsListResponseGroupsInner) o;
    return Objects.equals(this.title, groupsListResponseGroupsInner.title) &&
        Objects.equals(this.id, groupsListResponseGroupsInner.id) &&
        Objects.equals(this.automatic, groupsListResponseGroupsInner.automatic) &&
        Objects.equals(this.name, groupsListResponseGroupsInner.name) &&
        Objects.equals(this.displayName, groupsListResponseGroupsInner.displayName) &&
        Objects.equals(this.userCount, groupsListResponseGroupsInner.userCount) &&
        Objects.equals(this.mentionableLevel, groupsListResponseGroupsInner.mentionableLevel) &&
        Objects.equals(this.messageableLevel, groupsListResponseGroupsInner.messageableLevel) &&
        Objects.equals(this.visibilityLevel, groupsListResponseGroupsInner.visibilityLevel) &&
        Objects.equals(this.primaryGroup, groupsListResponseGroupsInner.primaryGroup) &&
        Objects.equals(this.grantTrustLevel, groupsListResponseGroupsInner.grantTrustLevel) &&
        Objects.equals(this.incomingEmail, groupsListResponseGroupsInner.incomingEmail) &&
        Objects.equals(this.hasMessages, groupsListResponseGroupsInner.hasMessages) &&
        Objects.equals(this.flairUrl, groupsListResponseGroupsInner.flairUrl) &&
        Objects.equals(this.flairBgColor, groupsListResponseGroupsInner.flairBgColor) &&
        Objects.equals(this.flairColor, groupsListResponseGroupsInner.flairColor) &&
        Objects.equals(this.bioRaw, groupsListResponseGroupsInner.bioRaw) &&
        Objects.equals(this.bioCooked, groupsListResponseGroupsInner.bioCooked) &&
        Objects.equals(this.bioExcerpt, groupsListResponseGroupsInner.bioExcerpt) &&
        Objects.equals(this.publicAdmission, groupsListResponseGroupsInner.publicAdmission) &&
        Objects.equals(this.publicExit, groupsListResponseGroupsInner.publicExit) &&
        Objects.equals(this.allowMembershipRequests, groupsListResponseGroupsInner.allowMembershipRequests) &&
        Objects.equals(this.fullName, groupsListResponseGroupsInner.fullName) &&
        Objects.equals(this.defaultNotificationLevel, groupsListResponseGroupsInner.defaultNotificationLevel) &&
        Objects.equals(this.membershipRequestTemplate, groupsListResponseGroupsInner.membershipRequestTemplate) &&
        Objects.equals(this.isGroupUser, groupsListResponseGroupsInner.isGroupUser) &&
        Objects.equals(this.isGroupOwner, groupsListResponseGroupsInner.isGroupOwner) &&
        Objects.equals(this.membersVisibilityLevel, groupsListResponseGroupsInner.membersVisibilityLevel) &&
        Objects.equals(this.canSeeMembers, groupsListResponseGroupsInner.canSeeMembers) &&
        Objects.equals(this.canAdminGroup, groupsListResponseGroupsInner.canAdminGroup) &&
        Objects.equals(this.canEditGroup, groupsListResponseGroupsInner.canEditGroup) &&
        Objects.equals(this.publishReadState, groupsListResponseGroupsInner.publishReadState)&&
        Objects.equals(this.additionalProperties, groupsListResponseGroupsInner.additionalProperties);
  }

  @Override
  public int hashCode() {
    return Objects.hash(title, id, automatic, name, displayName, userCount, mentionableLevel, messageableLevel, visibilityLevel, primaryGroup, grantTrustLevel, incomingEmail, hasMessages, flairUrl, flairBgColor, flairColor, bioRaw, bioCooked, bioExcerpt, publicAdmission, publicExit, allowMembershipRequests, fullName, defaultNotificationLevel, membershipRequestTemplate, isGroupUser, isGroupOwner, membersVisibilityLevel, canSeeMembers, canAdminGroup, canEditGroup, publishReadState, additionalProperties);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class GroupsListResponseGroupsInner {\n");
  ...
  * @throws IOException if the JSON Object is invalid with respect to GroupsListResponseGroupsInner
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!GroupsListResponseGroupsInner.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in GroupsListResponseGroupsInner is not found in the empty JSON string", GroupsListResponseGroupsInner.openapiRequiredFields.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : GroupsListResponseGroupsInner.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!GroupsListResponseGroupsInner.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'GroupsListResponseGroupsInner' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<GroupsListResponseGroupsInner> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(GroupsListResponseGroupsInner.class));

       return (TypeAdapter<T>) new TypeAdapter<GroupsListResponseGroupsInner>() {
           @Override
           public void write(JsonWriter out, GroupsListResponseGroupsInner value) throws IOException {
           ...
           @Override
           public GroupsListResponseGroupsInner read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             GroupsListResponseGroupsInner instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of GroupsListResponseGroupsInner given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of GroupsListResponseGroupsInner
  * @throws IOException if the JSON string is invalid with respect to GroupsListResponseGroupsInner
  */
  public static GroupsListResponseGroupsInner fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, GroupsListResponseGroupsInner.class);
  }

 /**
  * Convert an instance of GroupsListResponseGroupsInner to an JSON string
  *
  * @return JSON string
  */
