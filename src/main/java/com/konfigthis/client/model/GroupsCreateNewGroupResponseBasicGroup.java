...
public class GroupsCreateNewGroupResponseBasicGroup {
  ...
  public GroupsCreateNewGroupResponseBasicGroup() {
  }

  public GroupsCreateNewGroupResponseBasicGroup title(Object title) {
  ...
  **/
  ...
  public GroupsCreateNewGroupResponseBasicGroup id(Integer id) {
  ...
  **/
  ...
  public GroupsCreateNewGroupResponseBasicGroup automatic(Boolean automatic) {
  ...
  **/
  ...
  public GroupsCreateNewGroupResponseBasicGroup name(String name) {
  ...
  **/
  ...
  public GroupsCreateNewGroupResponseBasicGroup userCount(Integer userCount) {
  ...
  **/
  ...
  public GroupsCreateNewGroupResponseBasicGroup mentionableLevel(Integer mentionableLevel) {
  ...
  **/
  ...
  public GroupsCreateNewGroupResponseBasicGroup messageableLevel(Integer messageableLevel) {
  ...
  **/
  ...
  public GroupsCreateNewGroupResponseBasicGroup visibilityLevel(Integer visibilityLevel) {
  ...
  **/
  ...
  public GroupsCreateNewGroupResponseBasicGroup primaryGroup(Boolean primaryGroup) {
  ...
  **/
  ...
  public GroupsCreateNewGroupResponseBasicGroup grantTrustLevel(Object grantTrustLevel) {
  ...
  **/
  ...
  public GroupsCreateNewGroupResponseBasicGroup incomingEmail(Object incomingEmail) {
  ...
  **/
  ...
  public GroupsCreateNewGroupResponseBasicGroup hasMessages(Boolean hasMessages) {
  ...
  **/
  ...
  public GroupsCreateNewGroupResponseBasicGroup flairUrl(Object flairUrl) {
  ...
  **/
  ...
  public GroupsCreateNewGroupResponseBasicGroup flairBgColor(Object flairBgColor) {
  ...
  **/
  ...
  public GroupsCreateNewGroupResponseBasicGroup flairColor(Object flairColor) {
  ...
  **/
  ...
  public GroupsCreateNewGroupResponseBasicGroup bioRaw(Object bioRaw) {
  ...
  **/
  ...
  public GroupsCreateNewGroupResponseBasicGroup bioCooked(Object bioCooked) {
  ...
  **/
  ...
  public GroupsCreateNewGroupResponseBasicGroup bioExcerpt(Object bioExcerpt) {
  ...
  **/
  ...
  public GroupsCreateNewGroupResponseBasicGroup publicAdmission(Boolean publicAdmission) {
  ...
  **/
  ...
  public GroupsCreateNewGroupResponseBasicGroup publicExit(Boolean publicExit) {
  ...
  **/
  ...
  public GroupsCreateNewGroupResponseBasicGroup allowMembershipRequests(Boolean allowMembershipRequests) {
  ...
  **/
  ...
  public GroupsCreateNewGroupResponseBasicGroup fullName(Object fullName) {
  ...
  **/
  ...
  public GroupsCreateNewGroupResponseBasicGroup defaultNotificationLevel(Integer defaultNotificationLevel) {
  ...
  **/
  ...
  public GroupsCreateNewGroupResponseBasicGroup membershipRequestTemplate(Object membershipRequestTemplate) {
  ...
  **/
  ...
  public GroupsCreateNewGroupResponseBasicGroup membersVisibilityLevel(Integer membersVisibilityLevel) {
  ...
  **/
  ...
  public GroupsCreateNewGroupResponseBasicGroup canSeeMembers(Boolean canSeeMembers) {
  ...
  **/
  ...
  public GroupsCreateNewGroupResponseBasicGroup canAdminGroup(Boolean canAdminGroup) {
  ...
  **/
  ...
  public GroupsCreateNewGroupResponseBasicGroup canEditGroup(Boolean canEditGroup) {
  ...
  **/
  ...
  public GroupsCreateNewGroupResponseBasicGroup publishReadState(Boolean publishReadState) {
  ...
  **/
   ...
   * @return the GroupsCreateNewGroupResponseBasicGroup instance itself
   */
  public GroupsCreateNewGroupResponseBasicGroup putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    GroupsCreateNewGroupResponseBasicGroup groupsCreateNewGroupResponseBasicGroup = (GroupsCreateNewGroupResponseBasicGroup) o;
    return Objects.equals(this.title, groupsCreateNewGroupResponseBasicGroup.title) &&
        Objects.equals(this.id, groupsCreateNewGroupResponseBasicGroup.id) &&
        Objects.equals(this.automatic, groupsCreateNewGroupResponseBasicGroup.automatic) &&
        Objects.equals(this.name, groupsCreateNewGroupResponseBasicGroup.name) &&
        Objects.equals(this.userCount, groupsCreateNewGroupResponseBasicGroup.userCount) &&
        Objects.equals(this.mentionableLevel, groupsCreateNewGroupResponseBasicGroup.mentionableLevel) &&
        Objects.equals(this.messageableLevel, groupsCreateNewGroupResponseBasicGroup.messageableLevel) &&
        Objects.equals(this.visibilityLevel, groupsCreateNewGroupResponseBasicGroup.visibilityLevel) &&
        Objects.equals(this.primaryGroup, groupsCreateNewGroupResponseBasicGroup.primaryGroup) &&
        Objects.equals(this.grantTrustLevel, groupsCreateNewGroupResponseBasicGroup.grantTrustLevel) &&
        Objects.equals(this.incomingEmail, groupsCreateNewGroupResponseBasicGroup.incomingEmail) &&
        Objects.equals(this.hasMessages, groupsCreateNewGroupResponseBasicGroup.hasMessages) &&
        Objects.equals(this.flairUrl, groupsCreateNewGroupResponseBasicGroup.flairUrl) &&
        Objects.equals(this.flairBgColor, groupsCreateNewGroupResponseBasicGroup.flairBgColor) &&
        Objects.equals(this.flairColor, groupsCreateNewGroupResponseBasicGroup.flairColor) &&
        Objects.equals(this.bioRaw, groupsCreateNewGroupResponseBasicGroup.bioRaw) &&
        Objects.equals(this.bioCooked, groupsCreateNewGroupResponseBasicGroup.bioCooked) &&
        Objects.equals(this.bioExcerpt, groupsCreateNewGroupResponseBasicGroup.bioExcerpt) &&
        Objects.equals(this.publicAdmission, groupsCreateNewGroupResponseBasicGroup.publicAdmission) &&
        Objects.equals(this.publicExit, groupsCreateNewGroupResponseBasicGroup.publicExit) &&
        Objects.equals(this.allowMembershipRequests, groupsCreateNewGroupResponseBasicGroup.allowMembershipRequests) &&
        Objects.equals(this.fullName, groupsCreateNewGroupResponseBasicGroup.fullName) &&
        Objects.equals(this.defaultNotificationLevel, groupsCreateNewGroupResponseBasicGroup.defaultNotificationLevel) &&
        Objects.equals(this.membershipRequestTemplate, groupsCreateNewGroupResponseBasicGroup.membershipRequestTemplate) &&
        Objects.equals(this.membersVisibilityLevel, groupsCreateNewGroupResponseBasicGroup.membersVisibilityLevel) &&
        Objects.equals(this.canSeeMembers, groupsCreateNewGroupResponseBasicGroup.canSeeMembers) &&
        Objects.equals(this.canAdminGroup, groupsCreateNewGroupResponseBasicGroup.canAdminGroup) &&
        Objects.equals(this.canEditGroup, groupsCreateNewGroupResponseBasicGroup.canEditGroup) &&
        Objects.equals(this.publishReadState, groupsCreateNewGroupResponseBasicGroup.publishReadState)&&
        Objects.equals(this.additionalProperties, groupsCreateNewGroupResponseBasicGroup.additionalProperties);
  }

  @Override
  public int hashCode() {
    return Objects.hash(title, id, automatic, name, userCount, mentionableLevel, messageableLevel, visibilityLevel, primaryGroup, grantTrustLevel, incomingEmail, hasMessages, flairUrl, flairBgColor, flairColor, bioRaw, bioCooked, bioExcerpt, publicAdmission, publicExit, allowMembershipRequests, fullName, defaultNotificationLevel, membershipRequestTemplate, membersVisibilityLevel, canSeeMembers, canAdminGroup, canEditGroup, publishReadState, additionalProperties);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class GroupsCreateNewGroupResponseBasicGroup {\n");
  ...
  * @throws IOException if the JSON Object is invalid with respect to GroupsCreateNewGroupResponseBasicGroup
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!GroupsCreateNewGroupResponseBasicGroup.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in GroupsCreateNewGroupResponseBasicGroup is not found in the empty JSON string", GroupsCreateNewGroupResponseBasicGroup.openapiRequiredFields.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : GroupsCreateNewGroupResponseBasicGroup.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!GroupsCreateNewGroupResponseBasicGroup.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'GroupsCreateNewGroupResponseBasicGroup' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<GroupsCreateNewGroupResponseBasicGroup> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(GroupsCreateNewGroupResponseBasicGroup.class));

       return (TypeAdapter<T>) new TypeAdapter<GroupsCreateNewGroupResponseBasicGroup>() {
           @Override
           public void write(JsonWriter out, GroupsCreateNewGroupResponseBasicGroup value) throws IOException {
           ...
           @Override
           public GroupsCreateNewGroupResponseBasicGroup read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             GroupsCreateNewGroupResponseBasicGroup instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of GroupsCreateNewGroupResponseBasicGroup given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of GroupsCreateNewGroupResponseBasicGroup
  * @throws IOException if the JSON string is invalid with respect to GroupsCreateNewGroupResponseBasicGroup
  */
  public static GroupsCreateNewGroupResponseBasicGroup fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, GroupsCreateNewGroupResponseBasicGroup.class);
  }

 /**
  * Convert an instance of GroupsCreateNewGroupResponseBasicGroup to an JSON string
  *
  * @return JSON string
  */
