...
public class InvitesCreateInviteRequest {
  ...
  public InvitesCreateInviteRequest() {
  }

  public InvitesCreateInviteRequest email(String email) {
  ...
  **/
  ...
  @ApiModelProperty(example = "not-a-user-yet@example.com", value = "required for email invites only")
  ...
  public InvitesCreateInviteRequest skipEmail(Boolean skipEmail) {
  ...
  **/
  ...
  public InvitesCreateInviteRequest customMessage(String customMessage) {
  ...
  **/
  ...
  public InvitesCreateInviteRequest maxRedemptionsAllowed(Integer maxRedemptionsAllowed) {
  ...
  **/
  ...
  public InvitesCreateInviteRequest topicId(Integer topicId) {
  ...
  **/
  ...
  public InvitesCreateInviteRequest groupIds(String groupIds) {
  ...
  **/
  ...
  public InvitesCreateInviteRequest groupNames(String groupNames) {
  ...
  **/
  ...
  public InvitesCreateInviteRequest expiresAt(String expiresAt) {
  ...
  **/
   ...
   * @return the InvitesCreateInviteRequest instance itself
   */
  public InvitesCreateInviteRequest putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    InvitesCreateInviteRequest invitesCreateInviteRequest = (InvitesCreateInviteRequest) o;
    return Objects.equals(this.email, invitesCreateInviteRequest.email) &&
        Objects.equals(this.skipEmail, invitesCreateInviteRequest.skipEmail) &&
        Objects.equals(this.customMessage, invitesCreateInviteRequest.customMessage) &&
        Objects.equals(this.maxRedemptionsAllowed, invitesCreateInviteRequest.maxRedemptionsAllowed) &&
        Objects.equals(this.topicId, invitesCreateInviteRequest.topicId) &&
        Objects.equals(this.groupIds, invitesCreateInviteRequest.groupIds) &&
        Objects.equals(this.groupNames, invitesCreateInviteRequest.groupNames) &&
        Objects.equals(this.expiresAt, invitesCreateInviteRequest.expiresAt)&&
        Objects.equals(this.additionalProperties, invitesCreateInviteRequest.additionalProperties);
  }
  ...
  public String toString() {
    ...
    sb.append("class InvitesCreateInviteRequest {\n");
  ...
  * @throws IOException if the JSON Object is invalid with respect to InvitesCreateInviteRequest
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!InvitesCreateInviteRequest.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in InvitesCreateInviteRequest is not found in the empty JSON string", InvitesCreateInviteRequest.openapiRequiredFields.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!InvitesCreateInviteRequest.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'InvitesCreateInviteRequest' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<InvitesCreateInviteRequest> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(InvitesCreateInviteRequest.class));

       return (TypeAdapter<T>) new TypeAdapter<InvitesCreateInviteRequest>() {
           @Override
           public void write(JsonWriter out, InvitesCreateInviteRequest value) throws IOException {
           ...
           @Override
           public InvitesCreateInviteRequest read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             InvitesCreateInviteRequest instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of InvitesCreateInviteRequest given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of InvitesCreateInviteRequest
  * @throws IOException if the JSON string is invalid with respect to InvitesCreateInviteRequest
  */
  public static InvitesCreateInviteRequest fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, InvitesCreateInviteRequest.class);
  }

 /**
  * Convert an instance of InvitesCreateInviteRequest to an JSON string
  *
  * @return JSON string
  */
