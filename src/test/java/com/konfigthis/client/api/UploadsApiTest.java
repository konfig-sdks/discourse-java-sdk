...
public class UploadsApiTest {
    ...
    public void abortMultipartUploadTest() throws ApiException {
        String externalUploadIdentifier = null;
        UploadsAbortMultipartUploadResponse response = api.abortMultipartUpload(externalUploadIdentifier)
                .execute();
    ...
    public void completeExternalUploadTest() throws ApiException {
        ...
        String forPrivateMessage = null;
        String forSiteSetting = null;
        String pasted = null;
        UploadsCompleteExternalUploadResponse response = api.completeExternalUpload(uniqueIdentifier)
    ...
    public void completeMultipartUploadTest() throws ApiException {
        String uniqueIdentifier = null;
        List parts = null;
        UploadsCompleteMultipartUploadResponse response = api.completeMultipartUpload(uniqueIdentifier, parts)
                .execute();
        // TODO: test validations
    }
     ...
     */
    @Test
    public void createMultipartExternalUploadTest() throws ApiException {
        String uploadType = null;
        String fileName = null;
        Integer fileSize = null;
        UploadsInitiateDirectExternalUploadRequestMetadata metadata = null;
        UploadsCreateMultipartExternalUploadResponse response = api.createMultipartExternalUpload(uploadType, fileName, fileSize)
                .metadata(metadata)
                .execute();
        // TODO: test validations
    }
     ...
     */
    @Test
    public void createNewUploadTest() throws ApiException {
        String type = null;
        Integer userId = null;
        Boolean synchronous = null;
        File _file = null;
        UploadsCreateNewUploadResponse response = api.createNewUpload(type)
                .userId(userId)
     ...
     */
    @Test
    public void generatePresignedUrlsForMultipartPartsTest() throws ApiException {
        List partNumbers = null;
        String uniqueIdentifier = null;
        UploadsGeneratePresignedUrlsForMultipartPartsResponse response = api.generatePresignedUrlsForMultipartParts(partNumbers, uniqueIdentifier)
                .execute();
        // TODO: test validations
    }
     ...
     */
    @Test
    public void initiateDirectExternalUploadTest() throws ApiException {
        String type = null;
        String fileName = null;
        Integer fileSize = null;
        UploadsInitiateDirectExternalUploadRequestMetadata metadata = null;
        UploadsInitiateDirectExternalUploadResponse response = api.initiateDirectExternalUpload(type, fileName, fileSize)
                .metadata(metadata)
                .execute();
        // TODO: test validations
    }
